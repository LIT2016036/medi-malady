...
$cont = file_get_contents("https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=25.43184,81.771225&radius=10000&type=hospital&key=AIzaSyD6PyURM2qCatrH37nHiDfDzZPlJVaxvLU", false, stream_context_create($arrContextOptions));
...
if(isset($_POST['submit'])) {
	...
	$conn=mysqli_connect('localhost','root','1234','medipas');
