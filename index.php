			...
			<ul>
				...
				<li>
						...
						<div class="container">
								<div class="agileits-banner-info">
								 <span>Real</span>
									<h3>Free Nearby Hospital Consultation </h3>
								</div>
							</div>
						</div>
				</li>
				<li>
						<div class="w3layouts-banner-top w3layouts-banner-top2">
							<div class="container">
								<div class="agileits-banner-info">
								     <span>Amazing Information</span>
									<h3> Choose Correct Medicine</h3>
									</div>
							</div>
						</div>
					</li>
		 ...
		 <div class="about-w3lsrow">
				...
				<div class="col-md-6 col-sm-7 w3about-img two">
					<div class="w3about-text">
						...
						<p>Keeping in mind all the facts related to disease, nutrients and medicines, we came up with this website to help you in all possible ways we can. You can review to the medical authentication, and also get the nearest location of hospital. So, just be with us and let us help you!.</p>
                    </div>
				</div>
				<div class="clearfix"> </div>
			</div>
