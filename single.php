			...
			<div class="single-grid" >
               ...
               <form class="submit-form" action="#" method="POST">
                  <b> SELECT YOUR DISEASE </b>
									...
									<br>
								 <form class="reset-form" action="new.php" method="POST">
...
if(isset($_POST['submit'])) {
	...
	if($result2=mysqli_query($conn,$sql2))
	{
		...
		echo '<a href="https://www.betterhealth.vic.gov.au/health/healthyliving/calcium">'.$row1[0]."<br>".'</a>';
	}
	if($result3=mysqli_query($conn,$sql3))
	{
		while($row1 = mysqli_fetch_array($result3))
		echo '<a href="http://www.open.edu/openlearncreate/mod/oucontent/view.php?id=315&printable=1">'.$row1[0]."<br>";
	}
